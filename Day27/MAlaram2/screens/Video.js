...
import { View, Text,Image, StyleSheet, Dimensions,Modal,AsyncStorage,TextInput,Button,TouchableOpacity} from 'react-native';
    ...
    //  this.ModelingMethod();
        if (Boolean(this.state.run1)==true) {
          ...
          return(
            ...
            <Text style={styles.logoText}>Solve the equation to close the Alarm</Text>
            <Text style={styles.logoText}>{this.state.no1} * {this.state.no2} + {this.state.no3}=</Text>
            <TextInput
            ...
            selectionColor="#fff"
          />
          <TouchableOpacity style={styles.button1} onPress={()=>this._setModelClose(false)}>
